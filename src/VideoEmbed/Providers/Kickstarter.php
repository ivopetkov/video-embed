...
class Kickstarter extends \IvoPetkov\VideoEmbed\Provider
{

    static function load($url, $result)
    {
        $response = file_get_contents('http://www.kickstarter.com/services/oembed?url=' . urlencode($url).'&format=json');
